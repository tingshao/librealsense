...
## Notice: Before You Go Proceed Further ##
...
**To Node.js users**: if you're using Node.js and want to use [Node.js librealsense API](https://www.npmjs.com/package/node-librealsense), please use
```
npm install --save node-librealsense
```
to install it directly. Usage examples can be found in `node_modules/node-librealsense/examples` dir.
